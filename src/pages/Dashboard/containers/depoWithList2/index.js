...
export class DepoWithList extends React.Component {
  ...
  pageInit = props => {
    ...
    this.props.actions.getDepowithList({
      ...this.state,
  ...
  handleTableChange = (pagination, filters, sorter) => {
    ...
    this.getDepowithList(Object.assign({}, this.state, { current }));
  };
  handleTypeChange = e => {
    const { currencySelect } = this.state;
    this.urlJump(
      `/assetAction/depowith?currencySelect=${currencySelect}&typeSelect=${e}`
    )();
    this.setState({ typeSelect: e });
    this.getDepowithList(Object.assign({}, this.state, { typeSelect: e }));
  };
  handleChange = e => {
    const { typeSelect } = this.state;
    this.urlJump(
      `/assetAction/depowith?currencySelect=${e}&typeSelect=${typeSelect}`
    )();
    this.setState({ currencySelect: e, typeSelect });
    this.getDepowithList(
  ...
  render() {
    ...
    //       {formatMessage({ id: 'depoWithList.all' })}
    //     </div>
    //   </Option>
    // );

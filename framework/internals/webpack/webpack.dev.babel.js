...
const dllPlugin = appConfig.isCard ? undefined : pkg.dllPlugin;
...
const plugins = [
  ...
  new HtmlWebpackPlugin({
    ...
    template: appConfig.indexDevHtml,
  }),
...
module.exports = require('./webpack.base.babel')({
  ...
  output: {
    filename: `[name]${appConfig.isCard ? '' : '.[hash]'}.js`,
    chunkFilename: `[name]${appConfig.isCard ? '' : '.[hash].chunk'}.js`,
  },

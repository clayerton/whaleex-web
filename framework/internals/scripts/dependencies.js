...
const fwRoot = process.env.npm_package_config_framework;
...
exec(`cross-env BUILDING_DLL=true webpack --display-chunks --color --config ${fwRoot}/internals/webpack/webpack.dll.babel.js --hide-modules`);
